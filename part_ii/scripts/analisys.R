...
# Resumo estatístico da amostra
# summary(amostra_idade)
...
#   message("📂 [DEBUG] - Lendo o arquivo de dados: ", ARQUIVO_DADOS)
  ...
  # Leitura do CSV com configuração apropriada
  ...
  # Verificação se a coluna 'Idade' existe
  # if (!"Idade" %in% names(dados)) {
  #   stop("❌ ERRO: A coluna 'Idade' não foi encontrada no arquivo.")
  # }

  # message("📊 [DEBUG] - Visualizar as primeiras linhas para verificar\n")
  ...
  # Remover linhas com NA em 'Idade' e converter para numérico
  # dados$Idade <- as.numeric(dados$Idade)
  # dados_idade <- na.omit(dados$Idade)

  # Checar se há pelo menos 25 observações válidas
  # if (length(dados_idade) < 25) {
  #   stop("❌ ERRO: Menos de 25 valores válidos de idade disponíveis.")
  # }
  ...
  # Selecionar amostra aleatória de 25 eleitores
  # amostra_idade <- sample(dados_idade, size = 25)

  # Exibir a amostra
  # message("📊 [INFO] Amostra aleatória de 25 valores de Idade:")
  # print(amostra_idade)
...
# message("------------------------------------------\n")
# message("\n📈 [INFO] Gerando gráfico de probabilidade normal (Q-Q Plot)...")
...
# message("\n✅ [DEBUG] Gráfico gerado com sucesso.")
# message("------------------------------------------\n")
